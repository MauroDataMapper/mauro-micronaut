...
@Singleton
class SqlServerDataTypeProviderService implements DataTypePlugin{

    String name = "SqlServerDataTypeProviderService"

    String description = "Transact-SQL / MSSQL DataTypes"

    String version = "8.3.0-SNAPSHOT"
