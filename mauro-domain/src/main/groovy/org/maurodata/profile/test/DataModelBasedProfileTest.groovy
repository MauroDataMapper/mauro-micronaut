package org.maurodata.profile.test

import org.maurodata.domain.datamodel.DataModel
import org.maurodata.profile.ProfileSpecificationFieldProfile
import org.maurodata.profile.ProfileSpecificationProfile

class DataModelBasedProfileTest {

    static String testProfileModelName = "Asset management profile"
    static String testProfileModelNamespace = "com.test.assets"

    static DataModel testProfileModel = DataModel.build {
        label testProfileModelName
    ...
    static DataModel testAppliedProfileModel = DataModel.build {
        label "Data Asset 1"
        description "My first data asset"
        metadata(testProfileModelNamespace,
                 ["size"        : "1.5",
                  "priority"    : "3",
