...
@McpToolDefinition(
    ...
    avoidWhen = [
        'searching unknown catalogue content by label or keyword; use mauro_search first',
...
class ResourceLookupToolHandler extends AbstractAnnotatedToolHandler {
    ...
    String modelText(Map<String, Object> result) {
        ...
        renderModelTextSections([
            ...
            'Answer Instructions': [
                ...
                'If a previous mauro_search result already contains the required id and domain type, use that id to call mauro_get rather than asking the user to confirm it.'
            ]
        ] as Map<String, Object>)
    }
    ...
    private static List<String> noMatchGuidance(String query, int count) {
        ...
        [
            ...
            'If the query is a catalogue item label, call mauro_search first to find the item id and domain type.',
