...
class FailedHttpResourceInterpretation implements ResultInterpretation {
    ...
    ResultInterpretationOutput interpret(ResultContext context) {
        ...
        if (context.statusCode == 404) {
            ...
            answerInstructions.add('IC: If the URI id does not match the requested label, call the correct mauro_get action or call mauro_keyword_search for the exact label and retry.')
