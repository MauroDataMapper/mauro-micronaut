...
@McpToolDefinition(
    ...
    avoidWhen = [
        'discovering unknown catalogue items by keyword; use mauro_keyword_search first',
    ...
    examples = [
        ...
        'after mauro_keyword_search returns a DataModel id, call mauro_get with mauro-api://http-get/api/dataModels/ID'
    ],
...
class ResourceReadToolHandler extends AbstractAnnotatedToolHandler {
    ...
    private static List<String> currentAnswerSource(int status, boolean success, Map<String, Object> result) {
        ...
        List<String> source = [
            ...
            'Answer from this fetched resource, not from an earlier mauro_keyword_search result page.',
    ...
    private static List<String> identityCheckBranch(int status, boolean success) {
        ...
        [
            ...
            'IC: If prior mauro_keyword_search or mauro_list Returned Data contains that exact label, compare that row ID with the ID used in this failed URI.',
            ...
            'IC: If the matching label is not visible in prior Returned Data, call mauro_keyword_search for the exact requested label with the appropriate domainTypes; for a form/model label use domainTypes ["DataModel"].',
            'IC: After mauro_keyword_search returns the exact matching label, call mauro_get with that row ID.',
            'IC: Emit the mauro_keyword_search or mauro_get tool call now. Do not answer with "I will search", "please wait", or other prose promising a later tool call.',
