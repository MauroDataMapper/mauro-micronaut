...
class MicronautJavamailEmailPlugin implements EmailPlugin {
    ...
    @Override
    void sendEmail(CatalogueUser catalogueUserRecipient, uk.ac.ox.softeng.mauro.domain.email.Email email) throws Exception {
    ...
    @Override
    void retrySendEmail(uk.ac.ox.softeng.mauro.domain.email.Email email) throws Exception {
        emailSender.send(Email.builder()
                .from(new Contact('metadatacatalogue@gmail.com', 'Metadata Catalogue'))
