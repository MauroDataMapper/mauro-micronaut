...
@CompileStatic
abstract class CacheableAdministeredItemController<I extends AdministeredItem, P extends AdministeredItem> {
    ...
    CacheableAdministeredItemController(Class<I> itemClass, CacheableAdministeredItemRepository<I> administeredItemRepository, CacheableAdministeredItemRepository<P> parentItemRepository, AdministeredItemContentRepository<I
        > administeredItemContentRepository) {
