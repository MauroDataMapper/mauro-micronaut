...
public class EndSessionEndpointResolverReplacement extends EndSessionEndpointResolver {
     ...
     */
    public EndSessionEndpointResolverReplacement(BeanContext beanContext, TokenResolver tokenResolver, SecurityConfiguration securityConfiguration) {

        super(beanContext);
        log.debug("********* EndSessionEndpointREsolverReplacement. securityConfiguration: {}", securityConfiguration.toString());
