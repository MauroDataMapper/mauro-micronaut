...
class BaseIntegrationSpec extends Specification {
    ...
    public static final String JSON_EXPORTER_NAMESPACE = '/org.maurodata.plugin.exporter.json'
    ...
    public static final String JSON_IMPORTER_NAMESPACE = '/org.maurodata.plugin.importer.json'
