...
class DataModelNewBranchVersionIntegrationSpec extends CommonDataSpec {
    ...
    @Shared
    List<UUID> newBranchModelVersionDataClassIds
    ...
    void setup() {
        ...
        dataClassId1 = ((DataClass) POST("/dataModels/$dataModelId/dataClasses", [label: 'First data class', description: 'The first data class'], DataClass)).id
        dataClassId2 = ((DataClass) POST("/dataModels/$dataModelId/dataClasses", [label: 'Second data class', description: 'The second data class'], DataClass)).id
        dataClassId3 = ((DataClass) POST("/dataModels/$dataModelId/dataClasses/$dataClassId2/dataClasses", [label: 'Third data class', description: 'The third data class'], DataClass)).id

        dataElementId1 = ((DataElement) POST("/dataModels/$dataModelId/dataClasses/$dataClassId1/dataElements", [label: 'First data element', description: 'The first data element', dataType: [id: dataTypeId1]], DataElement)).id
        dataElementId2 = ((DataElement) POST("/dataModels/$dataModelId/dataClasses/$dataClassId1/dataElements", [label: 'Second data element', description: 'The second data element', dataType: [id: dataTypeId2]], DataElement)).id
