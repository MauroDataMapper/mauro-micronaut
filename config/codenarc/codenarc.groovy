...
ruleset {
    ...
    //ImplicitClosureParameter - use of 'it' can be cleaner than inventing a new parameter name
    //ImplicitReturnStatement - we might do this occasionally
    InvertedCondition
    InvertedIfElse
    ...
    //StaticMethodsBeforeInstanceMethods - DSL methods may appear in a block after the otherwise useful methods
    TernaryCouldBeElvis
    TrailingComma
    ...
    */
    ...
    // SpaceAroundMapEntryColon - Not sure I agree with this one
    SpaceAroundOperator
    ...
    SpockIgnoreRestUsed
    // SpockMissingAssert -- No such rule?
    UnnecessaryFail
    ...
    // ConfusingMethodName - DSL methods are deliberately named the same as properties
    // FactoryMethodName - We use "createdBy" as a property name all over the place
    FieldName
    InterfaceName
    ...
    // UnnecessaryCollectCall - Not sure * is always easier to read.
    ...
    // UnnecessaryReturnKeyword - We might do this occasionally
